...
let fgclink = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289514100332@whatsapp.net"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
he = `HELLO 👋 SELAMAT DATANG DI GROUP ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://www.youtube.com/@Zenn2`
let buttons = [
{buttonId: `zen`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
